...
//----------------------------------------------------------------------------------
static Model GenMeshCubicmap(Image cubicmap, float cubeSize); // Generate cubicmap mesh from image data
...
static void InitWindow(int width, int height)
{
    ...
    window = glfwCreateWindow(width, height, "PEC 03: 3D MAZE GAME", NULL, NULL);
...
static void InitGraphicsDevice(int width, int height)
{
    ...
    glClearColor(1.0f, 1.0f, 1.0f, 1.0f);                   // Set clear color (black)
...
static Model GenMeshCubicmap(Image cubicmap, Texture2D texMapAtlas, float cubeSize)
{
    Mesh mesh = { 0 };
    ...
    RectangleF rightTexUV;
    RectangleF leftTexUV;
    RectangleF frontTexUV;
    RectangleF backTexUV;
    RectangleF topTexUV;
    RectangleF bottomTexUV;

    for (int z = 0; z < mapHeight; ++z)
    {
        for (int x = 0; x < mapWidth; ++x)
        {
            if (cubicmapPixels[z * cubicmap.width + x].b == 0) {
                rightTexUV = (RectangleF){ 0.0f, 0.0f, 0.25f, 0.25f };
                leftTexUV = (RectangleF){ 0.25f, 0.0f, 0.25f, 0.25f };
                frontTexUV = (RectangleF){ 0.0f, 0.0f, 0.25f, 0.25f };
                backTexUV = (RectangleF){ 0.25f, 0.0f, 0.25f, 0.25f };
                topTexUV = (RectangleF){ 0.0f, 0.25f, 0.25f, 0.25f };
                bottomTexUV = (RectangleF){ 0.25f, 0.25f, 0.25f, 0.25f };
            }
            else if (cubicmapPixels[z * cubicmap.width + x].b == 1) {
                rightTexUV = (RectangleF){ 0.5f, 0.0f, 0.25f, 0.25f };
                leftTexUV = (RectangleF){ 0.75f, 0.0f, 0.25f, 0.25f };
                frontTexUV = (RectangleF){ 0.5f, 0.0f, 0.25f, 0.25f };
                backTexUV = (RectangleF){ 0.75f, 0.0f, 0.25f, 0.25f };
                topTexUV = (RectangleF){ 0.5f, 0.25f, 0.25f, 0.25f };
                bottomTexUV = (RectangleF){ 0.75f, 0.25f, 0.25f, 0.25f };
            }
            else if (cubicmapPixels[z * cubicmap.width + x].b == 2) {
                rightTexUV = (RectangleF){ 0.0f, 0.5f, 0.25f, 0.25f };
                leftTexUV = (RectangleF){ 0.25f, 0.5f, 0.25f, 0.25f };
                frontTexUV = (RectangleF){ 0.0f, 0.5f, 0.25f, 0.25f };
                backTexUV = (RectangleF){ 0.25f, 0.5f, 0.25f, 0.25f };
                topTexUV = (RectangleF){ 0.0f, 0.75f, 0.25f, 0.25f };
                bottomTexUV = (RectangleF){ 0.25f, 0.75f, 0.25f, 0.25f };
            }
            else if (cubicmapPixels[z * cubicmap.width + x].b == 3) {
                rightTexUV = (RectangleF){ 0.5f, 0.5f, 0.25f, 0.25f };
                leftTexUV = (RectangleF){ 0.75f, 0.5f, 0.25f, 0.25f };
                frontTexUV = (RectangleF){ 0.5f, 0.5f, 0.25f, 0.25f };
                backTexUV = (RectangleF){ 0.75f, 0.5f, 0.25f, 0.25f };
                topTexUV = (RectangleF){ 0.5f, 0.75f, 0.25f, 0.25f };
                bottomTexUV = (RectangleF){ 0.75f, 0.75f, 0.25f, 0.25f };
            }
            ...
            if (cubicmapPixels[z * cubicmap.width + x].r == 255)
            {
                ...
                if (((z < cubicmap.height - 1) &&
                    (cubicmapPixels[z * cubicmap.width + x].r == 255)) || (z == cubicmap.height - 1))
                {
                ...
                if (((z > 0) &&
                    (cubicmapPixels[z * cubicmap.width + x].r == 255)) || (z == 0))
                {
                ...
                if (((x < cubicmap.width - 1) &&
                    (cubicmapPixels[z * cubicmap.width + x].r == 255)) || (x == cubicmap.width - 1))
                {
                ...
                if (((x > 0) &&
                    (cubicmapPixels[z * cubicmap.width + x].r == 255)) || (x == 0))
                {
            ...
            // We check pixel color to be BLACK, we will only draw floor and roof
                    ...
                    (cubicmapPixels[z * cubicmap.width + x].r == 128))
            {
                // Define top triangles (2 tris, 6 vertex --> v1-v2-v3, v1-v3-v4)
                mapVertices[vCounter] = v1;
    ...
    //Use texture depending on .b
    UploadMeshData(&mesh);



    Model mapModel = LoadModel(mesh, texMapAtlas);
    return mapModel;
}
